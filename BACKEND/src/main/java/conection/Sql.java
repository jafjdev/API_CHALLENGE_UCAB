...
public class Sql {
  ...
  private static String BD_URL = "jdbc:postgresql://localhost/ucredits";
  ...
  /**
   * Metodo que realiza un query a la base de datos con devolucion Realizar preferiblemente antes de
   * bdConnect
   *
   * @param query
  ...
  /**
   * Metodo que realiza un query a la base de datos sin devolucion Realizar preferiblemente antes de
   * bdConnect
   *
   * @param query
   * @return boolean
  ...
  /**
   * metodo estatico para cerrar la conexion a la base de datos
   *
   * @param conn
   */
